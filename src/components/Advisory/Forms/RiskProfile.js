...
export default function RiskProfile() {
  ...
  const questions = [
    ...
    },
    {
      id: 2,
      question:
        "2) What comes to your mind when you think about RISK?",
      options: [
        "Danger",
        "Opportunity",
        "Uncertainty",
    ...
    {
      id: 3,
      question: "3) You suddenly came to know that your life insurance policy has expired, what will you do?",
      options: [
    ...
    {
      id: 5,
      question: "5) You have lost over Rs 5 Lacs in derivative trade in a day. How much risk will you take to cover your loss?",
      options: [
        "Rs 5,00,000",
        "Rs 2,50,000",
        "Rs 1,00,000",
    ...
    {
        id: 6,
        question: "6) How do you see your investment doing in normal market scenario?",
        options: [
      ...
      {
        id: 7,
        question: "7) How will you define your attitude towards making investment decisions?",
        options: [
      ...
      {
        id: 8,
        question: "8) Which investment portfolio will you choose from the given options of yearly returns?",
        options: [
      ...
      {
        id: 9,
        question: "9) How do you adapt or react to unforseen and unfavourable financial events?",
        options: [
      ...
      {
        id: 10,
        question: "10) What will you do if you made a huge investment in stock market and it falls by over 30% suddenly?",
        options: [
          "Nothing",
          "Will purchase more",
      ...
      {
        id: 11,
        question: "11) Do you make investments in high risk investment randomly to make quick money?",
        options: [
          "Very frequently",
          "Sometimes",
          "Rarely",
      ...
      {
        id: 12,
        question: "12) How would you rate your understanding of financial planning and financial products?",
        options: [
          "Robust",
          "Good",
          "Inadequate",
