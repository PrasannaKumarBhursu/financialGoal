            ...
            <Box sx={{ display: 'flex', flexDirection: 'row', pt: 2,p:4 }}>
              ...
              {activeStep !== steps.length &&
                (completed[activeStep] ? (
                  ...
                  <Button onClick={handleComplete} variant="contained" style={{ width: "20%", margin: "0 0 5%" }}>
              ...
              <Button onClick={handleNext} sx={{ mr: 1 }} variant="contained" style={{ width: "10%", margin: "0 0 5%" }}>
                Next
              </Button>
