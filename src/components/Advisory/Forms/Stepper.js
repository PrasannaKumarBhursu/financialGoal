...
import FinancialGoals from "./FinancialGoalsDetails/FinancialGoals";
...
export default function HorizontalNonLinearStepper() {
  ...
  const getStepContent = (steps) => {
    switch (steps) {
      ...
      case 1:
        return <IncomeForm next={handleComplete} />;
      case 2:
        return <Liability_details next={handleComplete} />;
      ...
      case 4:
        return <RiskProfile next={handleComplete} />;
      case 5:
        return <FinancialGoals next={handleComplete} />;
      case 6:
        return (
          //self declaration
