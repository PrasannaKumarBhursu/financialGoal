            ...
            <div className="tw-p-2">
                ...
                <div className="tw-hidden md:tw-block">
                    ...
                    <div className="tw-m-3 tw-border-black tw-rounded-xl tw-w-full md:tw-w-4/6 tw-mx-auto">
                        <h1 className=" tw-text-2xl md:tw-text-4xl tw-text-black tw-font-bold tw-pt-16 tw-mb-8 lg:tw-px-0 md:tw-px-16 tw-text-left md:tw-pl-4 tw-pl-4">Best FD Rates in India 2022</h1>
