                    ...
                    <div className=" tw-h-auto tw-border-4 tw-border-solid tw-rounded-2xl tw-border-nishblue-100">
                        ...
                        <div className="tw-flex tw-flex-col tw-justify-center tw-items-center tw-gap-12 tw-py-4">
                            <div className="tw-m-8 tw-flex tw-flex-col tw-justify-between md:tw-w-11/12 lg:tw-w-max tw-h-auto tw-border-black tw-shadow-xl tw-rounded-2xl">
                                ...
                                {/* Right Div Starts */}
                                <div className="tw-w-1/4" className="tw-flex tw-flex-col lg:tw-flex-row tw-gap-1">

                                    {/* Card 1 */}
                                    <div className="tw-flex tw-flex-col tw-bg-nishblue-400 md:w-full lg:tw-w-48 lg:tw-rounded-bl-xl tw-h-36">
                                    ...
                                    <div className=" tw-flex tw-flex-col tw-bg-nishblue-400 md:tw-w-full lg:tw-w-48 tw-h-36">
                                    ...
                                    {/* Card 2 */}
                                    <div className=" tw-flex tw-flex-col tw-bg-nishblue-400 md:w-full lg:tw-w-48 tw-h-36">
                                        <div className="tw-flex tw-flex-col tw-gap-3 tw-mx-5 tw-my-8">
                                            <p className="tw-text-nishblue-900 tw-text-sm tw-font-semibold">
                                    ...
                                    {/* Card 4 */}
                                    <div className="tw-flex tw-flex-col tw-bg-nishblue-400 md:w-full lg:tw-w-48 md:w-full lg:tw-w-48 lg:tw-rounded-br-xl tw-h-36">
                                        <div className="tw-flex tw-flex-col tw-gap-3 tw-mx-5 tw-my-8">
                                            <p className="tw-text-nishblue-900 tw-text-sm tw-font-semibold">
                                                Maturity Amount
                                            </p>
