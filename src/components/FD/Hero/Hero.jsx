                    ...
                    <div className="tw-bg-transparent tw-flex md:tw-flex-row tw-flex-col tw-gap-0 tw-justify-between tw-h-auto tw-p-0 tw-border-4 tw-rounded-2xl tw-border-solid tw-border-nishblue-100">
                        ...
                        <div className="tw-mx-auto tw-my-auto">
                            ...
                            <div>
                                ...
                                {/* Table Border Box */}
                                <div className=" tw-flex tw-flex-col tw-mb-6 tw-gap-0 tw-mx-auto tw-mt-6 md:tw-mt-0 md:tw-float-right lg:tw-m-auto md:tw-mr-2  md:tw-ml-0 tw-border-2 tw-w-max lg:tw-h-80 tw-h-64 tw-border-solid tw-border-nishblue-400 tw-rounded-xl ">

                                    {/* Table Top */}
                                    <div className="tw-w-max-content tw-rounded-t-lg tw-p-4 tw-border-b-0">
                                        <h1 className="tw-text-left md:tw-text-center tw-font-bold lg:tw-text-3xl md:tw-text-xl tw-text-lg tw-mb-2">
                                    ...
                                    <button className=" tw-m-auto tw-bg-nishyellow-400 md:tw-mt-2 lg:tw-mt-4 lg:tw-text-lg md:tw-text-sm tw-text-xs tw-rounded-md tw-h-10 lg:tw-w-2/4 lg:tw-h-32 md:tw-w-32 md:tw-h-12 tw-w-28  tw-font-semibold">
