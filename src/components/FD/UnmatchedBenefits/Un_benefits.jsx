    ...
    return (
        <>
            <div className="tw-m-3 tw-border-black tw-shadow-3xl tw-rounded-2xl">
                ...
                <div className="tw-border-nishblue-100 md:tw-p-8 tw-p-6">
                    <div className=" tw-border-4 tw-rounded-2xl tw-border-nishblue-100 ">
                        ...
                        <div className="tw-flex tw-flex-row tw-justify-center lg:tw-gap-10 tw-py-4 md:tw-gap-6 tw-gap-4 tw-flex-wrap">
                            <div className="tw-bg-nishblue-400 md:tw-w-60 md:tw-h-44 tw-h-32 tw-w-32 tw-rounded-xl">
                                <div>
                                ...
                                <div className="tw-w-full tw-flex tw-flex-col tw-mx-2 md:tw-mx-5 tw-my-4 md:tw-gap-1 md:tw-my-8">
                                    ...
                                    <p className="tw-text-xl md:tw-text-3xl tw-text-white tw-font-black">
                                        7.05%p.a.*
                                    </p>
                                    <p className="md:tw-text-base tw-text-xs tw-font-semibold ">For Senior Citizen</p>
                                </div>
                            </div>
                            <div className="tw-bg-nishblue-400 md:tw-w-60 md:tw-h-44 tw-h-32 tw-w-32 tw-rounded-xl">
                                <div>
                                ...
                                <div className="tw-w-full tw-flex tw-flex-col tw-mx-2 md:tw-mx-5 tw-my-4 md:tw-gap-1 md:tw-my-8">
                                    ...
                                    <p className="md:tw-text-base tw-text-xs tw--mt-1 md:tw-mt-0 tw-font-semibold">For Non Senior Citizen</p>
                                </div>
                            </div>
                            ...
                            <div className="tw-bg-nishblue-400 md:tw-w-60 md:tw-h-44 tw-h-32 tw-w-32 tw-rounded-xl">
                                ...
                                <div className="tw-w-full tw-flex tw-flex-col md:tw-gap-1 tw-gap-2 tw-mx-2 md:tw-mx-5 tw-my-4 md:tw-my-8">
                                    <p className="tw-text-white tw-text-xs md:tw-text-sm tw-font-semibold">
                                        Choose
                                    </p>
                                    <p className="tw-text-xl md:tw-text-3xl tw-text-white tw-font-black">
                                    ...
                                    <p className="md:tw-text-base tw-text-xs tw-font-semibold">Payout Interest</p>
                                </div>
                            </div>
                            <div className="tw-bg-nishblue-400 md:tw-w-60 md:tw-h-44 tw-h-32 tw-w-32 tw-rounded-xl">
                            <div>
                                ...
                                <div className="tw-w-full tw-flex tw-flex-col md:tw-gap-1 tw-gap-2 tw-mx-2 md:tw-mx-5 tw-my-4 md:tw-my-8">
                                    ...
                                    <p className="md:tw-text-base tw-text-xs tw-font-semibold">Of FD amount</p>
                                </div>
                            </div>
                            <div className="tw-bg-nishblue-400 md:tw-w-60 md:tw-h-44 tw-h-32 tw-w-32 tw-rounded-xl">
                                <div>
                                ...
                                <div className="tw-w-full tw-flex tw-flex-col md:tw-gap-1 tw-gap-2 tw-mx-2 md:tw-mx-5 tw-my-4 md:tw-my-8">
                                    ...
                                    <p className="md:tw-text-base tw-text-xs tw-font-semibold">Flexible Tenor</p>
                                </div>
                            </div>
                        </div>
                    </div>
