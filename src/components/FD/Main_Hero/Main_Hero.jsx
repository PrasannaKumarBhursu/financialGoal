        ...
        <>
            ...
            <div className="tw-h-max-content tw-m-3 tw-border-black tw-shadow-3xl tw-rounded-2xl">
                ...
                <div className=" tw-border-nishblue-100 md:tw-p-8">
                    <div className="tw-border-solid tw-bg-transparent tw-flex md:tw-flex-row-reverse tw-flex-col tw-gap-0 tw-justify-evenly tw-h-auto tw-p-0 tw-border-4 tw-rounded-2xl tw-border-nishblue-100">
                        {/* Left Div */}
                        {/* Brand Logo */}
                        <div className="md:tw-w-1/2 tw-p-0 tw-m-0">
                            <img className="tw-rounded-tl-xl tw-w-full md:tw-rounded-bl-xl tw--mr-1 tw--mb-1 tw-float-right lg:tw-w-max md:tw-h-full" src={mainhero} />
                        </div>
                        ...
                        <div className="tw-w-1/2 md:tw-my-auto tw-my-auto tw-mx-auto tw-w-max">
                            ...
                            {/* Table Border Box */}
                            <div className=" tw-flex tw-border-solid tw-flex-col tw-mb-6 tw-gap-0 tw-mt-6 md:tw-mt-0 md:tw-float-right lg:tw-mr-6 md:tw-ml-0 tw-border-2 tw-w-60 md:tw-w-60 lg:tw-w-max lg:tw-h-68 tw-h-64 tw-border-nishblue-400 tw-rounded-xl ">
                                ...
                                {/* Table Bottom */}
                                <div className="tw-text-center tw-border-solid tw-border-nishblue-400 tw-font-semibold tw-border-t-2 tw-border-b-0 tw-border-l-0 tw-border-r-0 tw-rounded-b-lg tw-p-4">
                                    <p>RATE OF INTEREST
                                        Up to 7.05% p.a.</p>
                                </div>
                            </div>
